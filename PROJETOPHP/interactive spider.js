...
function spawn() {
    ...
    // numero de pontos que existem na tela. 
     const pts = many(2000, () => {
        return {
            x: rnd(innerWidth),
            y: rnd(innerHeight),
   ...
   let r = innerWidth / rnd(50, 500); // quantidade de cordas que o spider pode ter
...
requestAnimationFrame(function anim(t) {
    ...
    ctx.fillStyle = "grey"; // cor de fundo
    drawCircle(0, 0, w * 10);
    ctx.fillStyle = ctx.strokeStyle = "white"; // mudar a cord do negocio
    t/=5000
